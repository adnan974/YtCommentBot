...
export async function startBrowserProfile() {
    const response = await axios.get(`http://localhost:3001/v1.0/browser_profiles/${PROFILE_ID}/start?automation=1`);
